...
*.[0-9]*)
	...
	if test ! -f /Users/Amy/Desktop/Game_2048/ncurses-5.9/man_alias.sed ; then
cat >>/Users/Amy/Desktop/Game_2048/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Users/Amy/Desktop/Game_2048/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /Users/Amy/Desktop/Game_2048/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /Users/Amy/Desktop/Game_2048/ncurses-5.9/man_alias.sed \
		< $i >$TMP
